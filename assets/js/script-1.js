...
$(document).ready(function(){
  function updateDescription(description){
    $('#deal h5').text(description);
  }
  $(document).on('click', '.fa-eye', function(){
    var description = $(this).closest('.swiper-slide').find('h5').text();
    updateDescription(description);
  });
});
...
$(document).ready(function(){
  function updateDescription(description){
    $('#deal .price').text(description);
  }
  $(document).on('click', '.fa-eye', function(){
    var description = $(this).closest('.swiper-slide').find('.price').text();
    updateDescription(description);
  });
});
